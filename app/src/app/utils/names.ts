...
export function generateDockerStyleName(uuid: string): string {
  ...
  const surnameIndex = (seed >> 8) % surnames.length; // Shift bits for different distribution
